...
class QuickDrawNeqModel(nn.Module):
    def __init__(self, model_config):
        super(QuickDrawNeqModel, self).__init__()
...
class QuickDrawLutModel(QuickDrawNeqModel):
    pass


class QuickDrawVerilogModel(QuickDrawNeqModel):
    pass
